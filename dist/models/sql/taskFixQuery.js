...
const taskFixQuery = (id, taskDetail, deadLine, nowDate) => __awaiter(void 0, void 0, void 0, function* () {
    const conn = yield promise_1.default.createConnection(mysqlConfig_1.default);
    const udateQuery = `UPDATE ${tableName_1.default.taskTable} SET taskDetail = ? , deadLine = ? , updateDate = ? WHERE id = ?`;
...
exports.default = taskFixQuery;
//# sourceMappingURL=taskFixQuery.js.map